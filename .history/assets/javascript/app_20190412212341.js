...
$("document").ready(function () {
  ...
  $(".answers").on("click", stopTimer);
  for (let i = 0; i < qArray.length; i++) {
    $("#question").text = qArray[i].question;
    console.log(qArray.question+ ' '+i)
...
function initGame() {
  ...
  misses = 0;
  seconds = 30;
  //qArray.jsGameState = States.PLAYING;
  loadQuestions();
  showTime();
 // newQuestion();
} 
...
qArray = [
    ...
    },
    {
      ...
      correct: 2,
      ansArray: ["Quantum gravity well", "3rd law of thermodynamics", "Black hole", "Mutual attraction"],
    ...
    },
    {
      ...
      correct: 2,
      ansArray: ["37 days", "189 days", "437 days", "500 days"],
    ...
    },
    {
      ...
      correct: 0,
      ansArray: ["Earth is between the Sun and the Moon", "Sun is between the Earth and the Moon", "Moon is in the 7th House", "Moon is between the Sun and the Earth"],
      extra: "A lunar eclipse occurs when the Moon passes directly behind Earth and into its shadow. This can occur only when the Sun, Earth, and Moon are exactly or very closely aligned, with Earth between the other two. A lunar eclipse can occur only on the night of a full moon."
    },
    {
