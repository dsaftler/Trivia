...
function gameOver()
{
  ...
  $("#showWinsCnt").text("You got : " + wins + " Correct")
  $("#showWinsCnt").show();
 
  $("#showLoseCnt").text("You got : " + wrongs + " Wrong")
  $("#showLoseCnt").show();
 
  $("#showMissCnt").text("You timed-out on : " + misses)
  $("#showMissCnt").show();
  //$("#wins").text(wins);
  // $("#wrongs").text(wrongs);
  // $("#misses").text(misses);
...
function showMe(result){
  ...
  showExtra();
  setTimeout(sevenSeconds, 1000 * 5)
  
  }
function showExtra(){
  $(".extra").text(qArray[i].extra);
